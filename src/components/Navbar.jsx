...
import { DollarSign, Wallet, Menu, X, Landmark, ListChecks, Moon, Sun } from 'lucide-react';
      ...
      >
        <div className="max-w-3xl mx-auto px-4">
          <div className="flex justify-between items-center h-14 sm:h-16">
            ...
            >
              <div className="w-8 h-8 sm:w-9 sm:h-9 bg-gradient-to-br from-primary-400 to-primary-600 rounded-xl flex items-center justify-center text-white shadow-md shadow-primary-500/25">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              {/* Balance Chip */}
              <div className="flex items-center bg-gray-100 dark:bg-gray-800 rounded-full px-3.5 py-1.5 gap-2">
              ...
              <motion.button
                whileTap={{ scale: 0.95 }}
                onClick={onWithdraw}
                className="text-sm font-semibold text-white bg-gray-900 dark:bg-white dark:text-gray-900 px-4 py-2 rounded-full hover:bg-gray-800 dark:hover:bg-gray-100 transition-colors shadow-sm"
              >
                Withdraw
              </motion.button>
            </div>
            ...
            <div className="flex md:hidden items-center gap-2.5">
              <div className="flex items-center bg-gray-100 dark:bg-gray-800 rounded-full px-3 py-1 gap-1.5">
              ...
              <div className="px-4 py-4 space-y-1">
                ...
                >
                  <span className="text-sm font-semibold text-gray-800 dark:text-gray-200 flex items-center gap-3">
                    {isDark ? <Sun size={18} className="text-primary-500" /> : <Moon size={18} className="text-primary-500" />}
                    {isDark ? 'Light Mode' : 'Dark Mode'}
                  </span>
                  <div className={`w-10 h-6 rounded-full transition-colors flex items-center px-0.5 ${isDark ? 'bg-primary-500' : 'bg-gray-300'}`}>
                    <motion.div
                ...
                <div className="pt-3">
                  <motion.button
                    ...
                    className="w-full bg-primary-600 hover:bg-primary-700 text-white px-4 py-3.5 rounded-2xl font-bold text-sm transition-colors shadow-sm flex justify-center items-center gap-2"
                  >
                    <Landmark size={16} />
                    Withdraw Cash
                  </motion.button>
